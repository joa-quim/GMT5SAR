...
void read_xcorr_data(struct xcorr xc, int iloc) {
	...
	tmp_m  = (short *) calloc(2*xc.m_nx, sizeof(short));             /* whole line */
	tmp2_m = (float *) calloc(2*xc.m_nx, sizeof(float));             /* whole line */
	tmp_s  = (short *) calloc(2*xc.s_nx, sizeof(short));             /* whole line */
	tmp2_s = (float *) calloc(2*xc.s_nx, sizeof(float));             /* whole line */
