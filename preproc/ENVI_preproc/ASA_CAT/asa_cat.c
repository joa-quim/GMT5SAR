...
//             printf( "Line %5d : duplicate line\n", outLines +1 );
             ...
             jjj = (int)floor((mdsrILen+1-30)/64);
             tempmdsrLineChar[jjj * 64] = (unsigned char) (0);
             ...
             for(msl = 1; msl <= nmsl; msl++){
                   ...
                   tempmdsrDsrTimeSeconds = (int)floor(temptimesec);
                   tempmdsrDsrTimeMicroseconds = (int)floor((temptimesec - (double)(tempmdsrDsrTimeSeconds))*1e06) ;
             ...
             imjd_diffsec = (int)floor(mjd_diffsec);
             ...
             fseek(outFilePtr, 0, SEEK_SET);  /* go back to start of the file */
