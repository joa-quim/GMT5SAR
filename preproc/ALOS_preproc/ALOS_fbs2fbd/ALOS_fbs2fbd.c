...
main (int argc, char **argv) {
	...
	fcomplex *cin, *cout;
	float rtest, itest;
	int	i, j, k, nffti, nffto, headsize;
	...
	if((indata = (unsigned char *) calloc(ibufsize,sizeof(unsigned char))) == NULL){
	...
	if((outdata = (unsigned char *) calloc(obufsize,sizeof(unsigned char))) == NULL){
