...
int main(int argc, char **argv){
    ...
    buff_c = (char *)calloc(MAX_CHAR_SIZE,sizeof(char));
    buff_o = (char *)calloc(MAX_CHAR_SIZE,sizeof(char));
    buff_d = (double *)calloc(MAX_NUM_SIZE,sizeof(double));
    buff_i = (int *)calloc(MAX_NUM_SIZE,sizeof(double));
...
int write_raw_hdf5(hid_t input, FILE *raw){
    ...
    buf = (unsigned char *)calloc(height*width,sizeof(unsigned char)*2);
