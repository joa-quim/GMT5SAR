...
int main(int argc, char **argv){
    ...
    buff_c = (char *)calloc(60000,sizeof(char));
    buff_o = (char *)calloc(60000,sizeof(char));
    buff_d = (double *)calloc(1000,sizeof(double));
    buff_i = (int *)calloc(1000,sizeof(double));
    ...
    strcat(tmp_str,".PRM");
    if ((OUTPUT_PRM = fopen(tmp_str,"wb")) == NULL) die ("Couldn't open prm file: \n",tmp_str);
    ...
    strcpy(tmp_str,argv[2]);
    strcat(tmp_str,".LED");
    if ((OUTPUT_LED = fopen(tmp_str,"wb")) == NULL) die ("Couldn't open led file: \n",tmp_str);
    write_orb_local(sv,OUTPUT_LED,n);
    fclose(OUTPUT_LED);
...
int write_slc_hdf5(hid_t input, FILE *slc){
    ...
    buf = (short *)calloc(height*width*2,sizeof(short));
    tmp = (short *)calloc(width*2,sizeof(short));
